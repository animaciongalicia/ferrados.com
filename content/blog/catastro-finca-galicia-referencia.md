...
Es un código alfanumérico de 20 caracteres que identifica de forma única cada inmueble en España. Por ejemplo: `15001A001000120000AB`. Los primeros dígitos indican la provincia y el municipio, y el resto identifica la parcela concreta.

Cada parcela catastral tiene asociados datos como la superficie, el uso (forestal, agrícola, urbano), el valor catastral y el titular. Estos datos los gestiona la Dirección General del Catastro, que depende del Ministerio de Hacienda.

## Cómo buscar la referencia catastral paso a paso
...
- **Por el mapa**: Navega visualmente hasta tu zona y haz clic en la parcela. El sistema te mostrará la referencia catastral, la superficie y el titular.

**Truco**: Si no sabes dónde está exactamente tu finca pero conoces alguna referencia cercana (la casa de un vecino, una iglesia, un camino), busca ese punto y navega desde ahí.

### 2. Sixpac (Visor geográfico de la Xunta)

El Sixpac es el visor de parcelas agrícolas de la Xunta de Galicia. No es exactamente el Catastro, pero superpone las parcelas catastrales sobre fotografía aérea de alta resolución, lo que facilita mucho identificar tu finca visualmente.

Es especialmente útil cuando los caminos y los límites naturales (ríos, muros, cunetas) son visibles en la foto aérea y te permiten orientarte.

### 3. Recibo del IBI

Si pagas IBI (Impuesto de Bienes Inmuebles) por la finca, la referencia catastral aparece en el recibo. Ojo: muchas fincas rústicas en Galicia están exentas de IBI o el propietario nunca ha recibido recibo porque el ayuntamiento no lo ha girado. Que no te llegue el IBI no significa que la finca no exista en el Catastro.

### 4. Escrituras o documentos antiguos

Si tienes escrituras, contratos de compraventa antiguos o documentos notariales, es posible que mencionen la referencia catastral o, al menos, el polígono y parcela, que te permite buscarla en la Sede Electrónica.

## Problemas habituales (y cómo resolverlos)

### La finca no aparece en el Catastro

Puede pasar por varias razones:
- La finca nunca se dio de alta (común en montes muy antiguos).
- Está integrada en otra parcela catastral más grande.
- Los límites catastrales no coinciden con los reales y tu finca aparece como parte de la del vecino.

**Solución**: Solicitar un alta o modificación catastral aportando documentación (escrituras, certificado del Registro de la Propiedad, o un informe topográfico).
...
### Finca dividida o agrupada incorrectamente

A veces una parcela catastral agrupa varias propiedades reales de distintos dueños (muy común en zonas de minifundio). O al revés: una sola finca aparece dividida en varias parcelas catastrales.

**Solución**: Se puede solicitar una segregación (dividir) o una agrupación (unir) ante el Catastro, aportando documentación y, normalmente, un plano topográfico.

## Catastro vs. Registro de la Propiedad: no son lo mismo

Esto genera mucha confusión:

| | Catastro | Registro de la Propiedad |
|---|---|---|
| **Quién lo gestiona** | Ministerio de Hacienda | Ministerio de Justicia |
| **Para qué sirve** | Inventario fiscal (impuestos) | Seguridad jurídica (propiedad) |
| **¿Es obligatorio?** | Sí (dar de alta inmuebles) | No (pero muy recomendable) |
| **¿Qué prevalece?** | La superficie catastral para impuestos | La inscripción registral para la propiedad |

**En la práctica**: Puedes ser el dueño en el Registro pero no figurar en el Catastro, y viceversa. Lo ideal es que ambos estén actualizados y coincidan, pero en Galicia eso es más la excepción que la norma.

## ¿Cuándo necesitas la referencia catastral obligatoriamente?
