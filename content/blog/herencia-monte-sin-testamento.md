...
Antes de asumir que no hay testamento, compruébalo. Pide el **certificado de últimas voluntades** en el Ministerio de Justicia (se puede hacer por internet, cuesta unos 4€). Hay que esperar 15 días desde el fallecimiento para solicitarlo. Este documento te dice si la persona otorgó testamento y ante qué notario.

A veces aparecen testamentos que la familia no sabía que existían. Y un testamento, aunque sea antiguo, simplifica mucho todo el proceso.

## El procedimiento: declaración de herederos abintestato

Sin testamento, hay que hacer una **declaración de herederos abintestato** ante notario. El proceso es el siguiente:

### 1. Acudir al notario con la documentación
...
- **Dos testigos** que conozcan al fallecido y su situación familiar, que no sean herederos ni familiares de los herederos

### 2. El notario redacta el acta de notoriedad

El notario levanta un acta donde los testigos declaran quiénes son los familiares del fallecido. Desde la reforma de 2015, todo se hace ante notario (antes había que ir al juzgado, que era mucho más lento).

**Plazo**: El acta se resuelve normalmente en 20-30 días.

### 3. Escritura de herencia

Con la declaración de herederos hecha, se procede igual que si hubiese testamento: escritura de adjudicación ante notario, donde se reparten los bienes.

## ¿Quién hereda sin testamento? El orden legal

La ley establece un orden estricto:

| Orden | Herederos | Parte que reciben |
|---|---|---|
| 1º | Hijos y descendientes | Partes iguales. El cónyuge tiene usufructo de 1/3 |
| 2º | Padres y ascendientes | Si no hay hijos. El cónyuge tiene usufructo de 1/2 |
| 3º | Cónyuge | Si no hay ni hijos ni padres. Hereda todo |
| 4º | Hermanos y sobrinos | Si no hay cónyuge, hijos ni padres |
| 5º | Otros parientes hasta 4º grado | Tíos, primos |
| 6º | El Estado | Si no hay parientes |

**Importante para Galicia**: La Ley de Derecho Civil de Galicia tiene algunas particularidades, como la "mejora de labrar y poseer" (apartado de la casa petrucial) y la legítima de los ascendientes. Un notario gallego conocerá estas particularidades.
...
| Acta de declaración de herederos (notario) | 250€ - 500€ |
| Escritura de adjudicación de herencia (notario) | 300€ - 1.000€ |
| Impuesto de sucesiones (familiares directos en Galicia) | 0€ - 200€ (con bonificación del 99%) |
| Registro de la Propiedad (por finca) | 100€ - 300€ |
| Actualización del Catastro | Gratuito |
| **Total orientativo (3 fincas)** | **1.000€ - 2.500€** |

Sin testamento, el sobrecoste respecto a una herencia con testamento es de 250€ a 500€ (el coste del acta de declaración de herederos).
...
- **Expediente de dominio** ante notario: Se publica un anuncio en el BOE y el tablón del ayuntamiento, y si nadie se opone en 30 días, el notario te reconoce la propiedad. Coste: 500€ - 1.500€.
- **Certificación catastral descriptiva y gráfica**: Si la finca está catastrada a nombre del fallecido (o de un ascendiente), esta certificación puede servir como título para inscribir. Es la vía más barata.
