...
- Las 5 hectáreas [pueden no coincidir con lo que dice el Catastro](/blog/catastro-escrituras-diferencia-lindes).
...
Una **leira** es una parcela de tierra, normalmente de cultivo. Un **ferrado** es la [unidad de medida tradicional](/blog/ferrado-metros-cuadrados-equivalencia) que todavía se usa en el día a día (y que cambia de tamaño según la zona, para más diversión).

¿Por qué te importa esto si quieres comprar? Porque:

- Los [marcos pueden estar movidos](/blog/marcos-finca-movidos-vecino) o desaparecidos, y lo que tú crees que compras puede no ser lo que realmente es.
...
El Catastro en Galicia tiene errores históricos enormes. [Superficies que no cuadran, parcelas que se solapan](/blog/catastro-finca-galicia-referencia), límites que no coinciden con la realidad. El Catastro no es prueba de propiedad. Nunca compres "con un pantallazo de Catastro".
...
### 4. Pensar que es "como comprar un piso"
Comprar en el rural es más complejo. Puede haber [herencias sin resolver](/blog/errores-heredar-fincas-rusticas-galicia), proindivisos con múltiples dueños, terrenos [sin escrituras claras](/blog/localizar-fincas-familiar-fallecido-sin-escrituras), restricciones urbanísticas que impiden la reforma... Si no lo revisas antes, lo descubres después. Y después es cuando ya has pagado.

### 5. No presupuestar la reforma antes de comprar
Comprar la casa es el principio. [La reforma puede costar 5 o 10 veces más](/blog/comprar-finca-rustica-barata-galicia-trampas) que la compra, y puede que ni siquiera sea viable. ¿Tiene acceso rodado? ¿Llega la luz? ¿Se puede meter agua? ¿Qué dice el PXOM? Si no has mirado esto antes de firmar, estás jugando a la ruleta.
...
**Antes de dar un paso, deja que alguien que conoce la zona y la ley te diga la verdad.** En [Ferrados.com](/compra-venta-terrenos-galicia) no vendemos propiedades: te conectamos con el profesional adecuado — abogado, topógrafo, arquitecto, técnico — para que compres con los ojos abiertos y no con el corazón cegado.

[Cuéntanos tu caso](/empezar) y te orientamos antes de que firmes nada.
