...
- **Eliminar matorral y maleza** (tojos, silvas, helechos, etc.).
- **Podar las ramas bajas** de los árboles hasta 1/3 de la altura del árbol.
- **Mantener distancias entre copas** de al menos 4 metros para frondosas y 6 metros para coníferas.
- **Retirar restos de corta**, ramas secas y vegetación muerta.

Si la Xunta inspecciona tu finca (normalmente a partir de junio) y no cumple, te envía una notificación. Y si no actúas, viene la multa.

## Tipos de notificación: no es lo mismo un requerimiento que una sanción

Es importante distinguir:

### Requerimiento de limpieza
Es un aviso previo. La Xunta te da un plazo (normalmente 15-30 días) para que limpies tu finca. Si cumples en plazo, no pasa nada. Sin sanción ni coste adicional (más allá de la limpieza).

### Ejecución subsidiaria
Si no limpias en el plazo del requerimiento, la Xunta envía a una empresa a limpiar tu finca y te pasa la factura. El coste suele ser **2 a 3 veces más caro** que si lo hubieses hecho tú, porque incluye los costes de gestión administrativa.

### Sanción (multa)
Además del coste de la ejecución subsidiaria, puede haber una multa que varía según la gravedad:
...
## Pasos a seguir cuando recibes la notificación

### 1. No ignores la carta

Es el error más común y el más caro. Cada día que pasa puede agravar la situación. Si te llega un requerimiento, tienes un plazo. Úsalo.
...
Contacta con 2-3 empresas de desbroce o trabajos forestales de tu zona. Les das la ubicación y la superficie y te hacen un presupuesto. Pide que el presupuesto incluya:
- Desbroce de matorral
- Poda de ramas bajas
- Retirada de restos (o trituración in situ)

### 4. Realiza la limpieza y guarda justificantes

Guarda las facturas de la empresa, fotos del antes y después, y cualquier documento que acredite que has cumplido. Los necesitarás si tienes que demostrar que has actuado.

### 5. Comunica a la Xunta que has cumplido

Presenta un escrito (por registro o sede electrónica) comunicando que has realizado la limpieza, adjuntando la factura y las fotos. Esto puede evitar la sanción o, al menos, reducirla.

## ¿Cuánto cuesta limpiar? Precios reales
...
| Con muros o zonas de difícil acceso | +20% sobre el precio base |

**Ejemplo real**: Una finca de 10 ferrados (~6.300 m²) con matorral denso y algunos árboles puede costar entre 1.000€ y 2.000€ de limpieza. Si lo hace la Xunta por ejecución subsidiaria, esa misma limpieza puede salir por 3.000€ a 5.000€.

## ¿Se puede recurrir la multa?

Sí, tienes derecho a presentar alegaciones. Las alegaciones más habituales:
